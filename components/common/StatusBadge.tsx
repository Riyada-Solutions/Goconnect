...
> = {
  ...
  "checked-in": { bg: "#E0E7FF", text: "#4F46E5", dot: "#6366F1", label: "Checked In" },
  no_show: { bg: "#F1F5F9", text: "#64748B", dot: "#94A3B8", label: "No Show" },
  "no-show": { bg: "#F1F5F9", text: "#64748B", dot: "#94A3B8", label: "No Show" },
