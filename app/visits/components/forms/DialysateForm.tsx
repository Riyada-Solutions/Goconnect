  ...
  return (
    <>
      ...
      <View style={s.formRow}>
        <FormField label="Na" value={dialysate.na} onChangeText={(v) => onChange({ ...dialysate, na: v })} colors={colors} half />
        <FormField label="HCO₃" value={dialysate.hco3} onChangeText={(v) => onChange({ ...dialysate, hco3: v })} colors={colors} half />
      </View>
      <View style={s.formRow}>
        <FormField label="K" value={dialysate.k} onChangeText={(v) => onChange({ ...dialysate, k: v })} colors={colors} half />
