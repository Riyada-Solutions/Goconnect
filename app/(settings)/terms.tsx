...
const TERMS_SECTIONS = [
  {
    ...
    content:
      "By accessing or using GoConnect, you agree to be bound by these Terms and Conditions. If you disagree with any part of these terms, you may not access the service.",
  },
  {
    title: "2. Use of Service",
    content:
      "GoConnect is designed for authorized healthcare professionals only. You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account.",
  },
  {
  ...
  },
  {
    ...
    content:
      "GoConnect is a healthcare management tool and does not provide medical advice. Clinical decisions remain the responsibility of qualified healthcare professionals.",
  },
  {
